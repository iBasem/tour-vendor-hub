  ...
  return (
    <div className="space-y-6 sm:space-y-8">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl sm:text-3xl font-bold text-gray-900">Travel Packages</h1>
      ...
      <div className="flex flex-col sm:flex-row gap-4">
        ...
        <Button variant="outline" className="w-full sm:w-auto border-gray-200 hover:bg-gray-50">
        ...
        {packages.map((pkg) => (
          ...
          >
            <CardHeader className="pb-3">
              <CardTitle className="text-lg sm:text-xl font-semibold text-gray-900 line-clamp-2">
                {pkg.title}
              </CardTitle>
            </CardHeader>
            <CardContent className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                <p className="text-xl sm:text-2xl font-bold text-blue-600">{pkg.price}</p>
